...
def main():
    ...
    parser.add_argument("--db", type=str, default="../trading-data-pipeline/data/trading.db", help="Path to DuckDB")
    parser.add_argument("--symbol", type=str, default="BTC/USDT", help="Symbol to backtest")
    parser.add_argument("--timeframe", type=str, default="1h", help="Timeframe")
    parser.add_argument("--strategy", type=str, default="sma", choices=["sma", "rsi", "breakout", "ml"], help="Strategy to run")
    ...
    if args.strategy == "sma":
        ...
        engine.strategy = BreakoutStrategy(
            symbol=args.symbol,
            period=20
        )
